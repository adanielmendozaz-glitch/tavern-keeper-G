...
gradle = gradle.replace(/versionName\s+["'][^"']+["']/, 'versionName "0.6.0"');
...
console.log('Android preparado: com.alfonso.tavernkeeper · versionCode 6 · versionName 0.6.0 · firma DEV estable.');
