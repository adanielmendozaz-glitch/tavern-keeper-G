...
gradle = gradle.replace(/versionName\s+["'][^"']+["']/, 'versionName "0.5.0"');
...
console.log('Android preparado: com.alfonso.tavernkeeper · versionCode 5 · versionName 0.5.0 · firma DEV estable.');
