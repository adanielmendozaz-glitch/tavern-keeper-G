...
gradle = gradle.replace(/versionName\s+["'][^"']+["']/, 'versionName "0.9.2"');
...
console.log('Android preparado: com.alfonso.tavernkeeper · versionCode 11 · versionName 0.9.2 · firma DEV estable.');
