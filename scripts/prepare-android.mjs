...
gradle = gradle.replace(/versionName\s+["'][^"']+["']/, 'versionName "0.9.3"');
...
console.log('Android preparado: com.alfonso.tavernkeeper · versionCode 12 · versionName 0.9.3 · firma DEV estable.');
